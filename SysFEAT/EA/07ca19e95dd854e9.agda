...
Documentation : https://framework.sysfeat.com/pages/07ca19e95dd854e9.htm

External references:
  OMG - SACM : AssuranceCasePackage: https://www.omg.org/spec/SACM/2.3/PDF#page=34
...
membershipOfAppliedControlMeasure = make_upwardNestingRelation "appliedControlMeasure membership" "nested appliedControlMeasure"

-- Aggregation relation
aggregationOfControlMeasureAppliedControlMeasure :  Linkage AppliedControlMeasure ControlMeasure
aggregationOfControlMeasureAppliedControlMeasure = make_Relation "ControlMeasure aggregation" "aggregated ControlMeasure"
...
membershipOfEnforcedDirective = make_upwardNestingRelation "enforcedDirective membership" "nested enforcedDirective"

-- Aggregation relation
aggregationOfControlDirectiveEnforcedDirective :  Linkage EnforcedDirective ControlDirective
aggregationOfControlDirectiveEnforcedDirective = make_Relation "ControlDirective aggregation" "aggregated ControlDirective"
...
membershipOfMitigatedRisk = make_upwardNestingRelation "mitigatedRisk membership" "nested mitigatedRisk"

-- Aggregation relation
aggregationOfRiskTypeMitigatedRisk :  Linkage MitigatedRisk RiskType
aggregationOfRiskTypeMitigatedRisk = make_Relation "RiskType aggregation" "aggregated RiskType"
