...
module SysFEAT.EA.b3c824665c709228 where -- ========== Security Measure Type

open import Agda.Primitive

SecurityMeasureType : ClassOfClassOfBoundedIndividual
SecurityMeasureType = ClassOfBoundedIndividual
